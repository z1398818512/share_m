...
/***/ (function(module, exports, __webpack_require__) {
	...
	function TZshare(selEle, options) {
	  alert(2);
	  //改变qq内置浏览器原生分享方式
	  if (device.isQQ) {
	    console.log(options);
	    ...
	    descript.setAttribute('content', options.digest);
	    ahead.appendChild(descript);
	    var aImg = document.createElement('meta');
	    aImg.setAttribute('itemprop', 'image');
	    aImg.setAttribute('content', options.pic);
	    ahead.appendChild(aImg);
	    ahead.querySelector('title').innerHTML = options.title;
	  }
	  document.getElementById(selEle).addEventListener(
	    'click',
	    function() {
	      soshm.popIn(options);
	    },
	...
	soshm.TZshare = function(selEle, options) {
	  alert(3);
	  //改变qq内置浏览器原生分享方式
	  if (device.isQQ) {
	    console.log(options);
	...
	soshm.popIn = function(options) {
	  ...
	  pop.innerHTML =
	    '<div class="soshm-pop-sites">' + getSitesHtml(options.sites, 3) + '</div>';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".soshm{text-align:center;-webkit-tap-highlight-color:rgba(0,0,0,0)}.soshm:after,.soshm:before{content:\" \";display:table}.soshm:after{clear:both}.soshm-item{float:left;margin:5px;cursor:pointer}.soshm-item-icon{box-sizing:content-box;display:inline-block;width:26px;height:26px;padding:5px;margin:0;vertical-align:middle;border-radius:50%}.soshm-item-icon img{vertical-align:top;padding:0;margin:0;width:100%;height:100%}.soshm-item-text{display:none;font-size:14px;color:#666}.soshm-item.weixin .soshm-item-icon{background:#49b233}.soshm-item.weixin:hover .soshm-item-icon{background:#398a28}.soshm-item.yixin .soshm-item-icon{background:#23cfaf}.soshm-item.yixin:hover .soshm-item-icon{background:#1ca38a}.soshm-item.weibo .soshm-item-icon{background:#f04e59}.soshm-item.weibo:hover .soshm-item-icon{background:#ec1f2d}.soshm-item.qzone .soshm-item-icon{background:#fdbe3d}.soshm-item.qzone:hover .soshm-item-icon{background:#fcad0b}.soshm-item.renren .soshm-item-icon{background:#1f7fc9}.soshm-item.renren:hover .soshm-item-icon{background:#18639d}.soshm-item.tieba .soshm-item-icon{background:#5b95f0}.soshm-item.tieba:hover .soshm-item-icon{background:#2c77ec}.soshm-item.douban .soshm-item-icon{background:#228a31}.soshm-item.douban:hover .soshm-item-icon{background:#186122}.soshm-item.tqq .soshm-item-icon{background:#97cbe1}.soshm-item.tqq:hover .soshm-item-icon{background:#6fb7d6}.soshm-item.qq .soshm-item-icon{background:#4081e1}.soshm-item.qq:hover .soshm-item-icon{background:#2066ce}.soshm-item.weixintimeline .soshm-item-icon{background:#1cb526}.soshm-item.weixintimeline:hover .soshm-item-icon{background:#15891d}.soshm-group{display:-ms-flexbox;display:flex;-ms-flex-pack:justify;justify-content:space-between;padding:15px 20px}.soshm-group .soshm-item{display:block;float:none;margin:0}.soshm-pop{display:none;position:fixed;top:0;left:0;right:0;bottom:0;height:100%;width:100%;opacity:0;z-index:9999;background:rgba(0,0,0,.65);transition-property:opacity;transition-timing-function:ease-in}.soshm-pop-show{opacity:1;transition-duration:.6s}.soshm-pop-show .group1{animation:soshtrans 1.2s 1 ease}.soshm-pop-show .group2{animation:soshtrans 1.7s 1 ease}.soshm-pop-show .group3{animation:soshtrans 2.2s 1 ease}.soshm-pop-show .group4{animation:soshtrans 2.7s 1 ease}.soshm-pop-hide{opacity:0;transition-duration:1s}.soshm-pop-hide .group1{animation:soshtrans2 .5s 1 cubic-bezier(.68,-.55,.265,1.55) 0ms forwards}.soshm-pop-hide .group2{animation:soshtrans2 .5s 1 cubic-bezier(.68,-.55,.265,1.55) .2s forwards}.soshm-pop-hide .group3{animation:soshtrans2 .5s 1 cubic-bezier(.68,-.55,.265,1.55) .4s forwards}.soshm-pop-hide .group4{animation:soshtrans2 .5s 1 cubic-bezier(.68,-.55,.265,1.55) .6s forwards}.soshm-pop-sites{position:absolute;top:50%;left:0;width:100%;transform:translateY(-50%)}.soshm-pop .soshm-item-icon{width:42px;height:42px;padding:10px}.soshm-weixin-sharetip{position:fixed;overflow:hidden;width:100%;height:100%;top:0;left:0;background:rgba(0,0,0,.6) url(" + __webpack_require__(16) + ") no-repeat right 0;background-size:50% auto;z-index:-1;opacity:0;visibility:hidden;transition:all .6s ease-out}.soshm-weixin-sharetip.weixin-sharetip-show{z-index:9999;opacity:1;visibility:visible}@keyframes soshtrans{0%{transform:translate3d(0,1136px,0)}50%{transform:translateZ(0)}60%{transform:translateZ(0)}to{transform:translateZ(0)}}@keyframes soshtrans2{0%{opacity:1;transform:translateZ(0)}to{opacity:0;transform:translate3d(0,500%,0)}}", ""]);
