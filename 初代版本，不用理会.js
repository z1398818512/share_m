(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['soshm'] = factory();
  else root['soshm'] = factory();
})(this, function() {
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var device = __webpack_require__(1); //判断为哪种浏览器
        ...
        if (
          (device.isIOS && device.ucBrowserVersion >= 10.2) ||
        ...
        function soshm(selector, options) {
          ...
          if (site && typeof history.replaceState === 'function') {
            var url = location.href.replace(
              new RegExp('[&?]__soshmbridge=' + site, 'gi'),
              ''
            );
        ...
        soshm.popIn = function(options) {
          ...
          var popDelegation = delegate(pop, '.soshm-item', 'click', function(
            e
          ) {
            var site = e.delegateTarget.dataset.site;
        ...
        function shareTo(site, data) {
          ...
          if (supportNativeShare) {
            if (device.isUCBrowser) {
              if (nativeShareApps[site]) {
                app = device.isIOS
                  ? nativeShareApps[site][0]
                  : nativeShareApps[site][1];
              }
          ...
          //         pic:
          //           'https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3309302851,1720520075&fm=27&gp=0.jpg',
          //         url: data.url
          //       });
          //     }
          //   );
          ...
          if (
            device.isWeixin &&
            (site.indexOf('weixin') !== -1 ||
              site.indexOf('qq') !== -1 ||
              site.indexOf('qzone') !== -1)
          ) {
          ...
          // 如果没有安装QQ浏览器则点击无反应
          if (site.indexOf('weixin') !== -1 && !device.isQQ) {
            var mttbrowserURL = appendToQuerysting(location.href, {
              __soshmbridge: site
            });
        ...
        function getSitesHtml(sites, groupsize) {
          var html = '';
          var groupsize =
            getType(groupsize) === 'number' && groupsize !== 0 ? groupsize : 0;
          for (var i = 0, length = sites.length; i < length; i++) {
            if (groupsize && i % groupsize === 0) {
              html +=
                '<div class="soshm-group group' + (i / groupsize + 1) + '">';
            }
            ...
            if (
              groupsize &&
              (i % groupsize === groupsize - 1 || i === length - 1)
            ) {
              html += '</div>';
            }
          }
      ...
      /***/ function(module, exports) {
        ...
        var device = {
          ...
          isQQBrowser: deviceDetect('MQQBrowser'), //qq，微信，qq浏览器
          isWeixin: deviceDetect('MicroMessenger'), //微信
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        if (false) {
          ...
          if (!content.locals) {
            module.hot.accept(
              '!!./../../node_modules/css-loader/index.js?minimize!./../../node_modules/postcss-loader/index.js!./../../node_modules/sass-loader/index.js!./index.scss',
              function() {
      ...
      /***/ function(module, exports) {
        module.exports =
          'data:image/png;base64,';
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        module.exports = {
          ...
          qzone: {
            ...
            api:
              'http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url={{url}}&title={{title}}&pics={{pic}}&desc={{digest}}',
            scheme: device.isIOS
          ...
          yixin: {
            ...
            api:
              'http://open.yixin.im/share?url={{url}}&title={{title}}&pic={{pic}}&desc={{digest}}'
          },
          weibo: {
            name: '微博',
          ...
          tqq: {
            ...
            api:
              'http://share.v.t.qq.com/index.php?c=share&a=index&url={{url}}&title={{title}}&pic={{pic}}'
          },
          renren: {
            name: '人人网',
            icon: __webpack_require__(11),
            api:
              'http://widget.renren.com/dialog/share?resourceUrl={{url}}&title={{title}}&pic={{pic}}&description={{digest}}'
          },
          douban: {
            name: '豆瓣',
            icon: __webpack_require__(8),
            api:
              'http://douban.com/recommend/?url={{url}}&title={{title}}&image={{pic}}'
          },
          tieba: {
            name: '百度贴吧',
            icon: __webpack_require__(12),
            api:
              'http://tieba.baidu.com/f/commit/share/openShareApi?url={{url}}&title={{title}}&desc={{digest}}'
          }
        };
...
//为了微信与qq内置的原生分享设置而自定义的方法
function TZshare(data) {
  var ua = navigator.userAgent.toLowerCase();
  function deviceDetect(needle) {
    needle = needle.toLowerCase();
    return ua.indexOf(needle) !== -1;
  ...
  if (deviceDetect('qq/')) {
    ...
    var descript = document.createElement('meta');
    descript.setAttribute('name', 'description');
    descript.setAttribute('itemprop', 'description');
    descript.setAttribute('content', data.digest);
    ahead.appendChild(descript);
    var aImg = document.createElement('meta');
    aImg.setAttribute('itemprop', 'image');
    aImg.setAttribute('content', data.pic);
    ahead.appendChild(aImg);
    ahead.querySelector('title').innerHTML = data.title;
  }
